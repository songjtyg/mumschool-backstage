package com.sjt.cai.mumschool.wechat.constant;
...
public class WeChatFinalValue {
	...
	public final static String USER ="https://api.weixin.qq.com/cgi-bin/user/info?access_token=ACCESS_TOKEN&openid=OPENID&lang=zh_CN";
